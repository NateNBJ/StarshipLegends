...
public class OwnCrewBarEventCreator extends BaseBarEventCreator {
	
	public PortsideBarEvent createBarEvent() {
		return new OwnCrewBarEvent();
	}
	...
	public float getBarEventFrequencyWeight() {
		return ModPlugin.REMOVE_ALL_DATA_AND_FEATURES ? 0
				: super.getBarEventFrequencyWeight() * OwnCrewBarEvent.getChanceOfAnyCrewEvent();
	}
