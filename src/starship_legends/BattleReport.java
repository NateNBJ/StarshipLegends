    ...
    public void createLargeDescription(CustomPanelAPI panel, float width, float height) {
        ...
        for (RepChange rc : changes) {
            String trait, status = rc.disabled ? "disabled" : (rc.deployed ? "deployed" : "reserved"),
                    loyalty = rc.captain != null && !rc.captain.isDefault() && rc.captainOpinionChange != 0
            ...
            switch (rc.captainOpinionChange) {
                case 0: loyaltyColor = Misc.getGrayColor(); break;
                case 1: loyaltyColor = Misc.getPositiveHighlightColor(); break;
                case -1: loyaltyColor = Misc.getNegativeHighlightColor(); break;
                default: loyaltyColor = Color.RED;
            }
